...
export default function Footer({ 
    ...
    return (
        <div className="bg-gradient-to-br from-[rgba(22,22,22,1)] to-[rgba(5,5,5,1)]">
            <div className={`
            flex bg-gradient-to-b from-[rgba(0,0,0,0.4)] to-[rgba(0,0,0,0)]
            ${followUsMinimal ? "flex-col justify-start items-start" : "justify-between items-center"}
        ...
        `}>
                ...
                {/* Follow Us */}
                {followUsVisible && (
                    <FollowUs frameSize={followUsFrameSize} textSize={followUsTextSize} gapSize={followUsGapSize} minimal={followUsMinimal} />
                )}
            </div>
        </div>
    )
