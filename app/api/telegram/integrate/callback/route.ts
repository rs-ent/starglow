      ...
      await prisma.$transaction(async (tx) => {
        await tx.player.update({
          ...
          data: {
            ...
            gameMoney: { increment: currentUserPlayer.gameMoney },
            usedCashMoney: { increment: currentUserPlayer.usedCashMoney },
            starPurchased: { increment: currentUserPlayer.starPurchased },
            recommendedCount: { increment: currentUserPlayer.recommendedCount },
            raffleTickets: { increment: currentUserPlayer.raffleTickets },
            vipUntil:
              existingTelegramUser.vipUntil && currentUserPlayer.vipUntil
                ? existingTelegramUser.vipUntil > currentUserPlayer.vipUntil
                  ? existingTelegramUser.vipUntil
                  : currentUserPlayer.vipUntil
                : existingTelegramUser.vipUntil || currentUserPlayer.vipUntil,
